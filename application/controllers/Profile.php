...
class Profile extends CI_Controller {
	...
	public function editprofile($id=''){
		...
		$this->db->update('pelanggan', $update,$where);
	...
	public function tiketsaya($id=''){
		$this->getsecurity();
		$data['tiket'] = $this->db->query("SELECT * FROM order_tiket WHERE kd_pelanggan ='".$id."' group by kd_order")->result_array();
		// die(print_r($data));
	...
	public function changepassword($id=''){
		...
		$pelanggan = $this->db->query("SELECT password_pelanggan FROM pelanggan where kd_pelanggan ='".$id."'")->row_array();
