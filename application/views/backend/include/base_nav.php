  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('backend/home') ?>">
        ...
        <div class="sidebar-brand-text mx-3">PO Sejahtera</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url() ?>backend/home">
          ...
          <a class="nav-link" href="<?php echo base_url() ?>backend/feedback_plg">
            <i class="fa fa-envelope"></i>
            <span>Data Feedback</span></a>
            
        <?php if ($this->session->userdata('level') == '2') { ?>

        <a class="nav-link" href="<?php echo base_url() ?>backend/order_tiket">
          <i class="fas fa-list-alt"></i>
          <span>List Order Tiket</span></a>
        ...
        <a class="nav-link" href="<?php echo base_url() ?>backend/kirim_barang">
          <i class="fas fa-list-alt"></i>
          <span>List Pengiriman Barang</span></a>

        <a class="nav-link" href="<?php echo base_url() ?>backend/tujuan">
          <i class="fas fa fa-compass"></i>
          <span>Tujuan</span></a>

        <a class="nav-link" href="<?php echo base_url() ?>backend/mobil">
          ...
          <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo base_url() ?>backend/admin_po">List User</a>
              </div>
            </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="text-dark small" ><?php echo  date('l, d-m-Y '); ?> &nbsp; </span>
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $this->session->userdata('nama_user'); ?></span>
                <img class="img-profile rounded-circle" src="<?php echo base_url($this->session->userdata('img_user')) ?>">
              </a>
