...
<html lang="en">
            ...
            <table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Pemesanan Tiket Pertanggal</td>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Pengiriman Barang Pertanggal</td>
                        <td style="text-align:center;">
                        <a class="btn btn-sm btn-default" href="#lap_barang_pertanggal" data-toggle="modal">Export Excel</a>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <!-- ============ MODAL ADD =============== -->
    <div class="modal fade" id="lap_barang_pertanggal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel">Pilih Tanggal </h3>
                </div>
                <form class="form-horizontal" method="post" action="<?php echo base_url('backend/laporan/laporbarang') ?>" target="_blank">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label col-xs-3" > Dari Tanggal</label>
                            <div class="col-xs-9">
