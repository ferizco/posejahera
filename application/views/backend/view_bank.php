    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-info">Kode BANK [<?php echo $bank['kd_bank']; ?>]  </h6>
        </div>
        <div class="card-body">             
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <p>Nomor Rekening : <b><?php echo $bank['no_rek_bank']; ?></b></p>
                  <img id="myImg" src="<?php echo base_url($bank['logo_bank']) ?>" alt="<?php echo $bank['nama_bank'] ?>" style="width:100%;max-width:300px">
                </div>
                <div class="col-sm-6">
                </div>
            </div>
