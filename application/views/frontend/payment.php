	...
	<body>
		...
		<section class="service-area section-gap relative">
			...
			<div class="container">
									...
									<table class="table table-striped">
										<thead>
											<tr>
												...
												<th scope="col">No jadwal [Kode Mobil]</th>
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $row['kd_jadwal']." [".$row['kd_mobil'].']' ?></td>
												<td><?php echo $now?></td>
								...
								<div class="offset-lg-1 col-lg-10 offset-sm-0 col-sm-12">
									<div class="row">
										<div class="col-md-3 col-4 mb-xs-10 pr-xs-0">
											<img src="<?php echo base_url().$tiket[0]['logo_bank'] ?>" height="50" width="100" alt="Icon Bank" />
										</div>
										<div class="col-md-6 col-8 mb-xs-10 rekening-text">
											<p ><input type="hidden" name="" id="myInput" value="<?php echo $tiket[0]['no_rek_bank']; ?> an <?php echo $tiket[0]['nasabah_bank'] ?>"><h4 id="myInput"><?php echo number_format((float)($tiket[0]['no_rek_bank']),0,"-","-"); ?> an <?php echo $tiket[0]['nasabah_bank'] ?></h4></p>
										</div>
									</div>
								</div>
				...
				var hours = Math.floor((distance % (1000 * 60 * 60 * 6)) / (1000 * 60 * 60));
